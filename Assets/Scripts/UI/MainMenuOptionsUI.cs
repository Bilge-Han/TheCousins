...
public class MainMenuOptionsUI : MonoBehaviour
{
    ...
    void LoadGraphicsSettings()
    {
        ...
        // Dropdown ve grafik ayarýný güncelle
    ...
    private void RebindBinding(GameInput.Binding binding)
    {
        ...
        {
            HidePressToRebindKey();    //Bir tuþ atadýktan sonra gelen ekraný kapatmak için
            UpdateVisual();           //Ekran kapanýnca textleri güncellemek için
        });
    }
}
