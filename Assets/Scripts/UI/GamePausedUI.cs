...
public class GamePausedUI : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            //Optionsu açarsak pause menüsünü kapatýyoruz
            Hide();
            //Pause menüsünde closebuttona basarsak gönderdiðimiz show metotu çalýþýyor ve pause menüsünü tekrar active ediyoruz.
